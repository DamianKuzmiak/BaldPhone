...
public class ContactInfoActivity extends BaldActivity {
    ...
    private void renderContactInfo(Contact contact) {
        ...
        if (contact.hasPhone()) new ContactSectionInflater().inflatePhones(contact.getPhones());
        ...
        if (contact.hasMail()) new ContactSectionInflater().inflateMails(contact.getEmails());
    ...
    private void inflateHistory(List<Call> calls) {
        ...
        ScrollingHelper scrollHelper = view.findViewById(R.id.scrolling_helper);
        ...
        Toggeler.newSimpleTextImageToggeler(
                ...
                R.string.show,
                R.string.hide,
                v -> scrollHelper.setVisibility(View.VISIBLE),
                v -> scrollHelper.setVisibility(View.GONE));
    ...
    private class ContactFieldBuilder {
        ...
        void add() {
            ...
            ((TextView) view.findViewById(R.id.fieldValue)).setText(value);
